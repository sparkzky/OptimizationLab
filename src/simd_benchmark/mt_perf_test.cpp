...
TestResult run_test(char* filepath,
    ...
    cout << " 完成 (" << fixed << setprecision(3) << duration.count() << "s, "
         << setprecision(1) << result.throughput_mb_s << " MB/s)" << endl;
...
int main(int argc, char* argv[]) {
    ...
    cout << left << setw(25) << "版本"
         << setw(15) << "时间(秒)"
         << setw(18) << "吞吐量(MB/s)"
         << setw(12) << "加速比" << endl;
    cout << string(70, '-') << endl;

    cout << left << setw(25) << "标量版本"
    ...
    cout << left << setw(25) << "单线程SIMD版本"
         << fixed << setprecision(4) << setw(15) << simd_avg.time_seconds
         << setprecision(2) << setw(18) << simd_avg.throughput_mb_s
         << setprecision(2) << simd_speedup << "x" << endl;

    double mt_speedup = baseline_avg.time_seconds / mt_avg.time_seconds;
    cout << left << setw(25) << "多线程SIMD版本"
         << fixed << setprecision(4) << setw(15) << mt_avg.time_seconds
         << setprecision(2) << setw(18) << mt_avg.throughput_mb_s
         << setprecision(2) << mt_speedup << "x" << endl;
    ...
    cout << "    加速比: " << fixed << setprecision(2) << simd_speedup << "x ("
         << setprecision(1) << (simd_speedup - 1.0) * 100 << "% 提升)" << endl;
    cout << "    吞吐量: " << setprecision(2) << baseline_avg.throughput_mb_s
         << " → " << simd_avg.throughput_mb_s << " MB/s" << endl;

    double mt_vs_simd = simd_avg.time_seconds / mt_avg.time_seconds;
    cout << "\n  单线程SIMD → 多线程SIMD:" << endl;
    cout << "    加速比: " << fixed << setprecision(2) << mt_vs_simd << "x ("
         << setprecision(1) << (mt_vs_simd - 1.0) * 100 << "% 提升)" << endl;
    cout << "    吞吐量: " << setprecision(2) << simd_avg.throughput_mb_s
         << " → " << mt_avg.throughput_mb_s << " MB/s" << endl;

    cout << "\n  标量 → 多线程SIMD (总提升):" << endl;
    cout << "    加速比: " << fixed << setprecision(2) << mt_speedup << "x ("
         << setprecision(1) << (mt_speedup - 1.0) * 100 << "% 提升)" << endl;
    cout << "    吞吐量: " << setprecision(2) << baseline_avg.throughput_mb_s
         << " → " << mt_avg.throughput_mb_s << " MB/s" << endl;
